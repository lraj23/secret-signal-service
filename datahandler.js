...
const dataFile = "ssservice.json";
const dataFilePath = join(import.meta.dirname, dataFile);
let SSService = JSON.parse(fs.readFileSync(dataFilePath, "utf8"));
...
function getSSService() {
	return cloneObj(SSService);
}

function saveState(data) {
	SSService = cloneObj(data);
